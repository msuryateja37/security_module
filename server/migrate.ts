...
async function runMigration() {
  ...
  const checkTableExistsInSqlite = async (tableName: string): Promise<boolean> => {
    const res = await sqliteDb.get<{ count: number }>(
  ...
  if (await checkTableExistsInSqlite('checklist_items')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM checklist_items');
  ...
  if (await checkTableExistsInSqlite('performance_stats')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM performance_stats');
  ...
  if (await checkTableExistsInSqlite('incidents')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM incidents');
  ...
  if (await checkTableExistsInSqlite('bto_reports')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM bto_reports');
  ...
  if (await checkTableExistsInSqlite('investigation_reports')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM investigation_reports');
  ...
  if (await checkTableExistsInSqlite('quarterly_reports')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM quarterly_reports');
  ...
  if (await checkTableExistsInSqlite('tra_audits')) {
    ...
    const items = await sqliteDb.all<any[]>('SELECT * FROM tra_audits');
