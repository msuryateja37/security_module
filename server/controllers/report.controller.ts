...
export const ReportController = {
  ...
  async getAllBto(req: Request, res: Response) {
    try {
  ...
  async createBto(req: Request, res: Response) {
    try {
  ...
  async getAllInv(req: Request, res: Response) {
    try {
  ...
  // Quarterly Reports
  async getAllQtr(req: Request, res: Response) {
    try {
  ...
  async createQtr(req: Request, res: Response) {
    try {
      const report = req.body;
  ...
  // TRA Audits
  async getAllTra(req: Request, res: Response) {
    try {
  ...
  async createTra(req: Request, res: Response) {
    try {
